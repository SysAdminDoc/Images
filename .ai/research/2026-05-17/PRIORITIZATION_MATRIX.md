...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| Semantic search | 5 | 5 | 5 | 5 | 4 | 6 | V7-31 foundation started with local index/search UI, provider seam, deterministic metadata embeddings, exact cosine search, delete controls, and Qdrant CLIP text/vision/tokenizer/preprocessor hash pins; next blockers are approved ONNX provider, runtime package selection, and model execution validation. |
