...
| S-QDRANT-CLIP-TOKENIZER | https://huggingface.co/Qdrant/clip-ViT-B-32-text/blob/main/tokenizer.json | Pinned tokenizer file SHA-256 and size for Model manager. |
...
| S-QDRANT-CLIP-PREPROCESSOR | https://huggingface.co/Qdrant/clip-ViT-B-32-vision/blob/main/preprocessor_config.json | Pinned vision preprocessor file SHA-256 and size for Model manager. |
