...
| Add target-format capability warnings before conversion. | ImageGlass and nomacs format matrices, local codec report. | High - shipped 2026-05-17 under V7-14 for export preview, batch preview, and macro dry-run warnings across alpha, animation, pages/layers, metadata, ICC profile, and lossy settings. |
