...
- **Export a copy** to JPEG, PNG, WebP, AVIF, JXL, TIFF, BMP, GIF, PSD/PSB, PDF/EPS/SVG, TGA, DDS, QOI, EXR, HDR, JPEG 2000, X11/Magick, production/scientific, and portable bitmap formats. APNG remains supported for opening and frame inspection, while copy/export writes normalize APNG targets to PNG.
