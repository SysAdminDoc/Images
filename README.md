...
[![Version](https://img.shields.io/badge/version-0.1.7-89b4fa?style=flat-square)](https://github.com/SysAdminDoc/Images/releases)
...
- **Togglable folder filmstrip** — a compact, cached thumbnail rail sits in the bottom chrome for nearby files in the current folder, with a side-panel fallback when hidden.
