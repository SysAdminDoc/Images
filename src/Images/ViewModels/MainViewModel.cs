...
public sealed class MainViewModel : ObservableObject, IDisposable
{
        ...
        Func<string?>? pickCompareFile = null)
    {
        ...
        BrowseFolderCommand = new AsyncRelayCommand(p => BrowseFolderAsync(p as string), _ => !IsOperationBusy);
        NextCommand = new AsyncRelayCommand(NextAsync, () => CanUseImageCommands);
        PrevCommand = new AsyncRelayCommand(PrevAsync, () => CanUseImageCommands);
        FirstCommand = new AsyncRelayCommand(FirstAsync, () => CanUseImageCommands);
        LastCommand = new AsyncRelayCommand(LastAsync, () => CanUseImageCommands);
        NextPageCommand = new AsyncRelayCommand(NextPageAsync, () => HasNextPage && !IsOperationBusy);
        PrevPageCommand = new AsyncRelayCommand(PrevPageAsync, () => HasPreviousPage && !IsOperationBusy);
        FirstPageCommand = new AsyncRelayCommand(FirstPageAsync, () => HasPreviousPage && !IsOperationBusy);
        LastPageCommand = new AsyncRelayCommand(LastPageAsync, () => HasNextPage && !IsOperationBusy);
        LeftBookPageTurnCommand = new AsyncRelayCommand(TurnLeftBookPageAsync, () => CanTurnLeftBookPage);
        RightBookPageTurnCommand = new AsyncRelayCommand(TurnRightBookPageAsync, () => CanTurnRightBookPage);
        ...
        ExportAnimationFrameCommand = new AsyncRelayCommand(ExportAnimationFrameAsync, () => IsAnimated);
        ...
        SaveAsCopyCommand = new AsyncRelayCommand(SaveAsCopyAsync, () => CanUseDisplayImageCommands);
        ...
        StripDeviceInfoCommand = new AsyncRelayCommand(() => StripMetadataAsync(MetadataStripCategory.DeviceInfo), () => CanUseImageCommands);
        StripTimestampsCommand = new AsyncRelayCommand(() => StripMetadataAsync(MetadataStripCategory.Timestamps), () => CanUseImageCommands);
        StripSoftwareCommand = new AsyncRelayCommand(() => StripMetadataAsync(MetadataStripCategory.Software), () => CanUseImageCommands);
        StripAllMetadataCommand = new AsyncRelayCommand(() => StripMetadataAsync(MetadataStripCategory.All), () => CanUseImageCommands);
        ExtractMotionVideoCommand = new AsyncRelayCommand(ExtractMotionVideoAsync, () => IsMotionPhoto || CompanionVideoPath is not null);
        PlayMotionVideoCommand = new AsyncRelayCommand(PlayMotionVideoAsync, () => IsMotionPhoto || CompanionVideoPath is not null);
