    ...
    public static string? SuggestionForDecodeFailure(string extension)
    {
        ...
        return ext switch
        {
            ...
            "zip" or "cbz" or "rar" or "cbr" or "7z" or "cb7"
                => "This archive did not expose supported image pages. Use an archive with image files at safe relative paths; encrypted or damaged archives may need to be extracted first.",
