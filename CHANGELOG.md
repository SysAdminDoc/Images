...
- **Archive reader controls** — active ZIP/CBZ books now get a side-panel book-controls card with current page progress and first/previous/next/last page actions.
