...
| 4 | Rating change | Enter review mode (L), press 3 for 3-star rating | Review mode toggle announced. "Rating: 3" or equivalent sidecar update feedback via status region. | | | | 1-5 rate, 0 clears, U undoes. |
| 5 | Pick / Reject | In review mode, press P then R | "Pick" label announced on P. "Reject" label announced on R. Side-panel review controls reflect state. | | | | U restores previous state. |
